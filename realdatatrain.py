...
def build_finalist_experiment_suite() -> list[ExperimentConfig]:
    return [
        ExperimentConfig(
            name="finalist_bev_fusion_recall_h96",
            model_type="bev_fusion",
            hidden_dim=96,
            dropout=0.14,
            lr=7e-4,
        ...
        ExperimentConfig(
            name="finalist_bev_fusion_precision_h96",
            model_type="bev_fusion",
            hidden_dim=96,
            dropout=0.12,
            lr=7.5e-4,
        ...
        ExperimentConfig(
            name="finalist_bev_fusion_precision_h128",
            model_type="bev_fusion",
            hidden_dim=128,
            dropout=0.10,
            lr=6.2e-4,
        ...
        ExperimentConfig(
            name="finalist_bev_fusion_recall_aux_h128",
            model_type="bev_fusion",
            hidden_dim=128,
            dropout=0.14,
            lr=6.2e-4,
...
def build_size_experiment_suite() -> list[ExperimentConfig]:
    return [
        ExperimentConfig(
            name="size_bev_fusion_recall_h64",
            model_type="bev_fusion",
            hidden_dim=64,
            dropout=0.14,
            lr=8.0e-4,
        ...
        ExperimentConfig(
            name="size_bev_fusion_recall_h96",
            model_type="bev_fusion",
            hidden_dim=96,
            dropout=0.14,
            lr=7.0e-4,
        ...
        ExperimentConfig(
            name="size_bev_fusion_recall_h128",
            model_type="bev_fusion",
            hidden_dim=128,
            dropout=0.14,
            lr=6.2e-4,
        ...
        ExperimentConfig(
            name="size_bev_fusion_recall_h160",
            model_type="bev_fusion",
            hidden_dim=160,
            dropout=0.16,
            lr=5.6e-4,
